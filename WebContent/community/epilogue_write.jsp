		...
		<div class="row">
			...
			<div class="body col-md-9">
				...
				<div class="bodyinborder">
					...
					<form action="<%=path%>/board/board_write_pro.jsp?board_num=2" method="post">
						...
						<div class="right">
							...
							<a href="<%=path%>/community/epilogue.jsp" class="btn btn-default">뒤로</a>
						</div>
