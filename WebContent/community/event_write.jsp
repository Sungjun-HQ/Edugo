		...
		<div class="row">
			...
			<div class="body col-md-9">
				...
				<div class="bodyinborder">
					...
					<form action="<%=path%>/board/board_write_pro.jsp?board_num=3" method="post">
						...
						<div class="right">
							<input type="submit" value="작성 완료" class="btn btn-default" style="outline: none;" />
							<input type="reset" value="초기화" class="btn btn-default" style="outline: none;" />
							<a href="<%=path%>/community/event.jsp" class="btn btn-default">뒤로</a>
						</div>
